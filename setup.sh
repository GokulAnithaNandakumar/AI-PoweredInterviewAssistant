...
echo "  Frontend: https://ai-powered-interview-assistant-chi.vercel.app"
echo "  Backend API: https://ai-poweredinterviewassistant.onrender.com"
echo "  API Docs: https://ai-poweredinterviewassistant.onrender.com/docs"